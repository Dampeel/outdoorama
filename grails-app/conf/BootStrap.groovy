    ...
    def init = { servletContext ->
		...
		if (Environment.current == Environment.DEVELOPMENT) {
			...
			def evt2 = new Evenement(nom: "SaintéLyon", lieu: "St-Etienne", departement: dept42,
				...
				.addToEpreuves(new Epreuve(nom: "SaintéLyon", date: Date.parse("dd/MM/yyyy", '01/07/2015'), distance: "72 km", denivele: 1800, famille: fam1, discipline: trail, lieuDepart: "Saint-Etienne", lieuArrivee: "Lyon", tarifMin: 20, tarifMax: 40, solo: true, equipe: true, relais: true))
			...
			def evt3 = new Evenement(nom: "Narbonne-Béziers", lieu: "Narbonne", departement: dept01)
				.addToEpreuves(new Epreuve(nom: "La course de la rose", date: Date.parse("dd/MM/yyyy", '01/08/2015'), distance: "10 km", denivele: 700, famille: fam1, discipline: running, lieuDepart: "Narbonne", lieuArrivee: "Béziers", tarifMin: 21, tarifMax: 9, solo: true, equipe: true, relais: true, courseFeminine: true, courseNocturne: true))
			...
			def evt5 = new Evenement(nom: "Test 3", lieu: "Grenoble", departement: dept38)
				.addToEpreuves(new Epreuve(date: Date.parse("dd/MM/yyyy", '01/05/2015'), distance: "10 km", famille: fam3, discipline: trail, solo: true, equipe: false, relais: true))
