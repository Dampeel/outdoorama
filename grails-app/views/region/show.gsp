	...
	<body>
		...
		<div class="container-fluid" role="main">
			...
			<ol class="list-group">
				...
				<g:if test="${regionInstance?.nom}">
				<li class="list-group-item">
    				<span class="badge">
						<g:message code="region.nom.label" default="Nom" />
					</span>
					
						<g:fieldValue bean="${regionInstance}" field="nom"/>
			...
			<g:form class="form-horizontal" url="[resource:regionInstance, action:'delete']" method="DELETE">
				<div class="form-group">
					<div class="col-sm-offset-2 col-sm-10">
						<g:link class="btn btn-default edit" action="edit" resource="${regionInstance}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
