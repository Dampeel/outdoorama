...
<html>
	...
	<body>
		...
		<div class="container-fluid" role="main">
			...
			<g:hasErrors bean="${horaireInstance}">
			<ul class="errors" role="alert">
				<g:eachError bean="${horaireInstance}" var="error">
				<li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
				</g:eachError>
			</ul>
			</g:hasErrors>
			
			<g:form class="form-horizontal" url="[resource:horaireInstance, action:'update']" method="PUT"  role="form">
				<fieldset>
					<g:hiddenField name="version" value="${horaireInstance?.version}" />
