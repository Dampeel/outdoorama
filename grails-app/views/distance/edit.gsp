...
<html>
	...
	<body>
		...
		<div class="container-fluid" role="main">
			...
			<g:hasErrors bean="${distanceInstance}">
			<ul class="errors" role="alert">
				<g:eachError bean="${distanceInstance}" var="error">
				<li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
				</g:eachError>
			</ul>
			</g:hasErrors>
			
			<g:form class="form-horizontal" url="[resource:distanceInstance, action:'update']" method="PUT"  role="form">
				<fieldset>
					<g:hiddenField name="version" value="${distanceInstance?.version}" />
